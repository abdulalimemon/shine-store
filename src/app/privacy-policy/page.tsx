    ...
    <section className="py-10 lg:py-14">
      <Container>
        ...
        <ul className="space-y-1 list-disc px-3 lg:px-10">
          ...
          <li>
            <p className="text-sm lg:text-base pb-5">First name and last name</p>
          </li>
          <li>
            <p className="text-sm lg:text-base pb-5">Address, State, Province, ZIP/Postal code, City</p>
          </li>
          <li>
            <p className="text-sm lg:text-base pb-5">Usage Data</p>
          </li>
        </ul>
        ...
        <ul className="space-y-1 list-disc px-3 lg:px-10">
          <li>
            ...
            <p className="text-sm lg:text-base pb-5">Type: Session Cookies</p>
            <p className="text-sm lg:text-base pb-5">Administered by: Us</p>
            <p className="text-sm lg:text-base pb-5">
          ...
          <li>
            ...
            <p className="text-sm lg:text-base pb-5">Type: Persistent Cookies</p>
            <p className="text-sm lg:text-base pb-5">Administered by: Us</p>
            <p className="text-sm lg:text-base pb-5">
        ...
        <h3 className="text-base lg:text-xl font-semibold pt-5">Retention of Your Personal Data</h3>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h3 className="text-base lg:text-xl font-semibold pt-5">Transfer of Your Personal Data</h3>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h3 className="text-base lg:text-xl font-semibold pt-5">Delete Your Personal Data</h3>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h3 className="text-base lg:text-xl font-semibold pt-5">Disclosure of Your Personal Data</h3>
        <h4 className="text-base lg:text-xl font-semibold pt-5">Business Transactions</h4>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h4 className="text-base lg:text-xl font-semibold pt-5">Law enforcement</h4>
        <p className="text-sm lg:text-base pb-5">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="text-base lg:text-xl font-semibold pt-5">Other legal requirements</h4>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h3 className="text-base lg:text-xl font-semibold pt-5">Security of Your Personal Data</h3>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h2 className="text-base lg:text-xl font-semibold pt-5">Children&apos;s Privacy</h2>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h2 className="text-base lg:text-xl font-semibold pt-5">Links to Other Websites</h2>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h2 className="text-base lg:text-xl font-semibold pt-5">Changes to this Privacy Policy</h2>
        <p className="text-sm lg:text-base pb-5">
        ...
        <h2 className="text-base lg:text-xl font-semibold pt-5">Contact Us</h2>
        <p className="text-sm lg:text-base pb-5">
        ...
        <ul className="space-y-1 list-disc px-3 lg:px-10">
          <li>
            ...
            <a
              href="https://shine-store.vercel.app/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://shine-store.vercel.app/contact
            </a>
          </li>
        </ul>
      </Container>
