        ...
        <div>
          ...
          <ul className="list-disc text-sm px-5 md:px-10">
            ...
            <li>
              <p className="text-sm py-1">
                ...
                in this Agreement) refers to Shine Store, Dhaka, Bangladesh.
              </p>
            </li>
            <li>
              <p className="text-sm py-1">
          ...
          <ul className="list-disc text-sm px-5 md:px-10 space-y-3">
            ...
            <li>
              ...
              affiliates to honor this Terms and Conditions. Affiliates include
          ...
          <p className="text-sm py-3">
            ...
            necessary for the purposes set out in this Terms and Conditions. We
          ...
          <p className="text-sm py-3">
            Your consent to this Terms and Conditions followed by Your
            submission of such information represents Your agreement to that
            transfer.
          </p>
          <p className="text-sm py-3">
            The Company will take all steps reasonably necessary to ensure that
            Your data is treated securely and in accordance with this Terms and
            Conditions and no transfer of Your Personal Data will take place to
          ...
          <h4 className="text-xl font-semibold mb-3">Business Transactions</h4>
          <p className="text-sm pb-3">
          ...
          <ul className="list-disc text-sm px-5 md:px-10 space-y-2 pb-20">
            <li>
              ...
              <a
                href="https://shine-store.vercel.app/terms-conditions"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://shine-store.vercel.app/terms-conditions
              </a>
            </li>
          </ul>
        </div>
