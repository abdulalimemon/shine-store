  ...
  return (
    <section className="py-10 lg:py-14">
      <Container>
        ...
        <p className="text-sm lg:text-base pb-5">Welcome to Shine Store!</p>

        <p className="text-sm lg:text-base pb-5">
          These terms and conditions outline the rules and regulations for the
          use of Shine Store&apos;s Website, located at
          https://shine-store.vercel.app/.
        </p>

        <p className="text-sm lg:text-base pb-5">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Shine Store if you do not agree to
          take all of the terms and conditions stated on this page.
        </p>

        <h3 className="text-base lg:text-xl font-semibold pt-5">
          <strong>Cookies</strong>
        </h3>

        <p className="text-sm lg:text-base pb-5">
          We employ the use of cookies. By accessing Shine Store, you agreed to
          use cookies in agreement with the Shine Store&apos;s Privacy Policy.{" "}
        </p>
        ...
        <p className="text-sm lg:text-base pb-5">
          Unless otherwise stated, Shine Store and/or its licensors own the
          intellectual property rights for all material on Shine Store. All
          intellectual property rights are reserved. You may access this from
          Shine Store for your own personal use subjected to restrictions set in
        ...
        <ul className="space-y-1 list-disc px-3 lg:px-10 pb-5">
          ...
          <li>Redistribute content from Shine Store</li>
        </ul>       

        <p className="text-sm lg:text-base pb-5">
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website.
          Shine Store does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Shine Store,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Shine Store
        ...
        <p className="text-sm lg:text-base pb-5">
          Shine Store reserves the right to monitor all Comments and to remove
        ...
        <p className="text-sm lg:text-base pb-5">
          You hereby grant Shine Store a non-exclusive license to use,
        ...
        <p className="text-sm lg:text-base pb-5">
          ...
          the hyperlink compensates the absence of Shine Store; and (d) the link
        ...
        <p className="text-sm lg:text-base pb-5">
          ...
          sending an e-mail to Shine Store. Please include your name, your
        ...
        <p className="text-sm lg:text-base pb-5">
          No use of Shine Store&apos;s logo or other artwork will be allowed for
